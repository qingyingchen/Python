...
class InterestAccount(BankAccount):
    def addInterest(self, interestrate):
        interest = self.Acct_balance * interestrate 
        print ("You got the interest of", interestrate*100, "percent.")
        self.deposit(interest)

myAccount = InterestAccount("Rich", "1473223", "348765.67")
myAccount.showbalance()
myAccount.deposit(2000)
myAccount.withdraw(5000)
myAccount.withdraw(5000000)
myAccount.addInterest(0.09)
